// VMX1020 processor definition file
// =================================
// Goal VMX1020 and Ramtron VMX51C1020
...
var
  ...
  DIGPOT1   : byte absolute $BA;
  DIGPOT2   : byte absolute $BB;
  ISRCCAL1  : byte absolute $BC;
  ISRCCAL2  : byte absolute $BD;
