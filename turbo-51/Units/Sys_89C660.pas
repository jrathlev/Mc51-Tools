// 89C66x processor definition file
// ================================
// Philips P89C660, P89C662, P89C664 and P89C668
// 
// Contributed by Klaus Lerchenmueller, 22 Apr 2004
// 
// Last modified: W.W. Heinz, 01 May 2004
// --------------------------------------
// - deleted S1IST register definition
// - deleted unusual bit symbols AD0 thru AD15 for P0 and P2
// - added bit symbols CEX3 and CEX4 for alternate functions of P3
// - renamed bit symbol CP (C8H) to the more ususal CPRL2
// - added bit symbol ET2 for IEN1
// 
// Reference: P89C660/P89C662/P89C664/P89C668 Data Sheet, 2002 Oct 28
