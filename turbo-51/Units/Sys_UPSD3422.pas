// uPSD3422 processor definition file
// ==================================
// ST uPSD3422, uPSD3433, uPSD3434, uPSD3454
...
var
  ...
  UADDR     : byte absolute $E2;
  UPAIR     : byte absolute $E3;
  UIE0      : byte absolute $E4;
  UIE1      : byte absolute $E5;
  UIE2      : byte absolute $E6;
  UIE3      : byte absolute $E7;
  UIF0      : byte absolute $E8;
  UIF1      : byte absolute $E9;
  UIF2      : byte absolute $EA;
  UIF3      : byte absolute $EB;
  UCTL      : byte absolute $EC;
  USTA      : byte absolute $ED;
  USEL      : byte absolute $EF;
  UCON      : byte absolute $F1;
  USIZE     : byte absolute $F2;
  UBASEH    : byte absolute $F3;
  UBASEL    : byte absolute $F4;
  USCI      : byte absolute $F5;
  USCV      : byte absolute $F6;
  CCON0     : byte absolute $F9;
  CCON1     : byte absolute $FA;
...
// P4
  ...
  RESUMF    : boolean absolute $E8;  // UIF0
  EOPF      : boolean absolute $E9;
  SUSPNDF   : boolean absolute $EA;
  RSTF      : boolean absolute $EB;
  NAKF      : boolean absolute $EC;
  OUTF      : boolean absolute $ED;
  INF       : boolean absolute $EE;
  GLF       : boolean absolute $EF;
