// uPSD3233 processor definition file
// ==================================
// ST uPSD3233, uPSD3234, uPSD3253, uPSD3254
...
var
  ...
  S1SETUP   : byte absolute $D1;
  S2SETUP   : byte absolute $D2;
  RAMBUF    : byte absolute $D4;
  DDCDAT    : byte absolute $D5;
  DDCADR    : byte absolute $D6;
  DDCCON    : byte absolute $D7;
  ...
  DDCSDA    : boolean absolute $C0;  // P4
  DDCSCL    : boolean absolute $C1;
  DDCVSYNC  : boolean absolute $C2;
  PWM_0     : boolean absolute $C3;
  ...
  ADDR      : boolean absolute $DB;
  STO       : boolean absolute $DC;
  STA       : boolean absolute $DD;
  ENI1      : boolean absolute $DE;
