// 83931HA processor definition file
// =================================
...
var
  ...
  HADDR     : byte absolute $97;
  HPPWR     : byte absolute $9A;
  HIE       : byte absolute $A1;
  FIE       : byte absolute $A2;
  IEN0      : byte absolute $A8;
  SADDR     : byte absolute $A9;
  HSTAT     : byte absolute $AE;
  ...
  HPCON     : byte absolute $CF;
  SOFL      : byte absolute $D2;
  SOFH      : byte absolute $D3;
  HPINDEX   : byte absolute $D4;
  HPSC      : byte absolute $D5;
  HPSTAT    : byte absolute $D7;
  ...
  HTXD0     : boolean absolute $E8;
  HRXD0     : boolean absolute $E9;
...
const
  ...
  USBHUB    = $43;  // USB Hub/SOF (isochronous endpoint)
