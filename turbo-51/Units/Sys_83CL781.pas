// 83CL781 processor definition file
// =================================
// Philips P83CL781 and P83CL782
...
var
  ...
  ET2       : boolean absolute $AE;


  PS0       : boolean absolute $BC;
  PS1       : boolean absolute $BD;
  PT2       : boolean absolute $BE;
  ...
  RTCLK     : boolean absolute $CC;
  GF2       : boolean absolute $CD;
