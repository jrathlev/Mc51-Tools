// 89C51CC03 processor definition file
// ===================================
// Atmel AT89C51CC03
...
var
  ...
  CANSIT1   : byte absolute $BA;
  CANSIT2   : byte absolute $BB;
  ...
  CANIE1    : byte absolute $C2;
  CANIE2    : byte absolute $C3;
  ...
  CANEN1    : byte absolute $CE;
  CANEN2    : byte absolute $CF;
  FCON      : byte absolute $D1;
  EECON     : byte absolute $D2;
  FSTA      : byte absolute $D3;
  SPCON     : byte absolute $D4;
  SPSCR     : byte absolute $D5;
  SPDAT     : byte absolute $D6;
  ...
  SS        : boolean absolute $B5;  // not present at the 44-pin parts
  ...
  MISO      : boolean absolute $C2;  // not present at the 44-pin parts
  SCK       : boolean absolute $C3;  // not present at the 44-pin parts
  MOSI      : boolean absolute $C4;  // not present at the 44-pin parts
