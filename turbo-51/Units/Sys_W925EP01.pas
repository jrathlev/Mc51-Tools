// W925EP01 processor definition file
// ==================================
// Winbond W925EP01
...
var
  ...
  P5H       : byte absolute $A3;
  P7        : byte absolute $A4;
  P6        : byte absolute $A5;
  P4        : byte absolute $A6;
  P5        : byte absolute $A7;
  P6H       : byte absolute $AA;
  P7H       : byte absolute $AB;
  P7IO      : byte absolute $AC;
  P6IO      : byte absolute $AD;
  P4IO      : byte absolute $AE;
  P5IO      : byte absolute $AF;
  ...
  BGCON     : byte absolute $CE;
  BG        : byte absolute $CF;
  WDCON     : byte absolute $D8;
  SFRAL     : byte absolute $E4;
  SFRAH     : byte absolute $E5;
  SFRFD     : byte absolute $E6;
  SFRCN     : byte absolute $E7;
  EIE       : byte absolute $E8;
  TA        : byte absolute $EE;
  CHPCON    : byte absolute $EF;
