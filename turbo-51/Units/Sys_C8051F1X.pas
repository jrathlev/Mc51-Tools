// C8051F1xx processor definition file
// ===================================
// Cygnal C8051F120/1/2/3/4/5/6/7 and C8051F130/1/2/3
...
var
  ...
  FLSTAT    : byte absolute $88;  // F
  CPT0MD    : byte absolute $89;  // 1
  CPT1MD    : byte absolute $89;  // 2
  PLL0CN    : byte absolute $89;  // F
  OSCICN    : byte absolute $8A;  // F
  OSCICL    : byte absolute $8B;  // F
  OSCXCN    : byte absolute $8C;  // F
  PLL0DIV   : byte absolute $8D;  // F
  CKCON     : byte absolute $8E;  // 0
  PLL0MUL   : byte absolute $8E;  // F
  PSCTL     : byte absolute $8F;  // 0
  PLL0FLT   : byte absolute $8F;  // F
  SSTA0     : byte absolute $91;  // 0
  MAC0BL    : byte absolute $91;  // 3
  MAC0BH    : byte absolute $92;  // 3
  MAC0ACC0  : byte absolute $93;  // 3
  MAC0ACC1  : byte absolute $94;  // 3
  MAC0ACC2  : byte absolute $95;  // 3
  MAC0ACC3  : byte absolute $96;  // 3
  SFRPGCN   : byte absolute $96;  // F
  MAC0OVR   : byte absolute $97;  // 3
  ...
  CCH0CN    : byte absolute $A1;  // F
  EMI0CN    : byte absolute $A2;  // 0
  CCH0TN    : byte absolute $A2;  // F
  EMI0CF    : byte absolute $A3;  // 0
  CCH0LC    : byte absolute $A3;  // F
  ...
  MAC0STA   : byte absolute $C0;  // 3
  SMB0STA   : byte absolute $C1;  // 0
  MAC0AL    : byte absolute $C1;  // 3
  SMB0DAT   : byte absolute $C2;  // 0
  MAC0AH    : byte absolute $C2;  // 3
  SMB0ADR   : byte absolute $C3;  // 0
  MAC0CF    : byte absolute $C3;  // 3
  ...
  MAC0RNDL  : byte absolute $CE;  // 3
  SMB0CR    : byte absolute $CF;  // 0
  MAC0RNDH  : byte absolute $CF;  // 3
  ...
  FLHBUSY   : boolean absolute $88;  // FLSTAT (page F)
  ...
  MAC0N     : boolean absolute $C0;  // MAC0STA (page 3)
  MAC0SO    : boolean absolute $C1;
  MAC0Z     : boolean absolute $C2;
  MAC0HO    : boolean absolute $C3;
