// 87LPC769 processor definition file
// ==================================
// Philips P87LPC769 and P87LPC779
...
var
  ...
  ADCON     : byte absolute $C0;
  DAC0      : byte absolute $C5;
  DAC1      : byte absolute $C6;
  ...
  CMP_1     : boolean absolute $86;  // original Philips names CMP1/CMP2 conflict with SFR
  ...
  DAC_1     : boolean absolute $96;  // original Philips names DAC1/DAC0 conflict with SFR
  DAC_0     : boolean absolute $97;

  FE        : boolean absolute $9F;

  CLKOUT    : boolean absolute $A0;  // P2
  X2        : boolean absolute $A0;
  ...
  AADR0     : boolean absolute $C0;  // ADCON
  AADR1     : boolean absolute $C1;
  RCCLK     : boolean absolute $C2;
  ADCS      : boolean absolute $C3;
  ADCI      : boolean absolute $C4;
  ENDAC0    : boolean absolute $C5;  // original Philips P87LPC779 names DAC0
  ENDAC1    : boolean absolute $C6;  // and DAC1 conflict with SFR
  ENADC     : boolean absolute $C7;

  CT0       : boolean absolute $C8;  // I2CFG
  CT1       : boolean absolute $C9;
  TIRUN     : boolean absolute $CC;
  CLRTI     : boolean absolute $CD;  // reads always as 0
