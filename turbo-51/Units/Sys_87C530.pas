// 87C530/83C530 processor definition file
// =======================================
...
var
  ...
  RTASS     : byte absolute $F2;
  RTAS      : byte absolute $F3;
  RTAM      : byte absolute $F4;
  RTAH      : byte absolute $F5;
  EIP       : byte absolute $F8;
  RTCC      : byte absolute $F9;
  RTCSS     : byte absolute $FA;
  RTCS      : byte absolute $FB;
  RTCM      : byte absolute $FC;
  RTCH      : byte absolute $FD;
  RTCD0     : byte absolute $FE;
  RTCD1     : byte absolute $FF;
