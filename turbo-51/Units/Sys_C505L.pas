// C505L processor definition file
// ===============================
...
var
  ...
  C31       : boolean absolute $B4;
  C30       : boolean absolute $B5;

  EADC      : boolean absolute $B8;  // IEN1
  ESWI      : boolean absolute $B9;
  ...
  C16       : boolean absolute $E8;  // P4
  C17       : boolean absolute $E9;
  C18       : boolean absolute $EA;
  C19       : boolean absolute $EB;
  C20       : boolean absolute $EC;
  C21       : boolean absolute $ED;
  C22       : boolean absolute $EE;
  C23       : boolean absolute $EF;

  C24       : boolean absolute $F8;  // P5
  C25       : boolean absolute $F9;
  C26       : boolean absolute $FA;
  C27       : boolean absolute $FB;
  C28       : boolean absolute $FC;
  C29       : boolean absolute $FD;
