// C8051F34x processor definition file
// ===================================
// Silicon Labs C8051F340/1/2/3/4/5/6/7
...
var
  EMI0TC    : byte absolute $84;
  EMI0CF    : byte absolute $85;
  OSCLCN    : byte absolute $86;
  ...
  USB0ADR   : byte absolute $96;
  USB0DAT   : byte absolute $97;
  ...
  SBCON1    : byte absolute $AC;
  P4MDOUT   : byte absolute $AE;
  PFE0CN    : byte absolute $AF;
  OSCXCN    : byte absolute $B1;
  OSCICN    : byte absolute $B2;
  OSCICL    : byte absolute $B3;
  SBRLL1    : byte absolute $B4;
  SBRLH1    : byte absolute $B5;
  FLSCL     : byte absolute $B6;
  FLKEY     : byte absolute $B7;
  CLKMUL    : byte absolute $B9;
  ...
  P3MDIN    : byte absolute $F4;
  P4MDIN    : byte absolute $F5;
  ...
  T2CSS     : boolean absolute $C9;
  TR2       : boolean absolute $CA;
  T2SPLIT   : boolean absolute $CB;
  T2CE      : boolean absolute $CC;
