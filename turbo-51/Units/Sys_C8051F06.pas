// C8051F06x processor definition file
// ===================================
// Cygnal C8051F060/1/2/3/4/5/6/7
...
var
  ...
  ADC0CPT   : byte absolute $BA;  // F
  AMX0SL    : byte absolute $BB;  // 0
  AMX2SL    : byte absolute $BB;  // 2
  ADC0CCF   : byte absolute $BB;  // F
  ADC0CF    : byte absolute $BC;  // 0
  ADC1CF    : byte absolute $BC;  // 1
  ADC2CF    : byte absolute $BC;  // 2
  ADC0L     : byte absolute $BE;  // 0
  ADC1L     : byte absolute $BE;  // 1
  ADC2L     : byte absolute $BE;  // 2
  ADC0H     : byte absolute $BF;  // 0
  ADC1H     : byte absolute $BF;  // 1
  ADC2H     : byte absolute $BF;  // 2
  ...
  ADC2GTL   : byte absolute $C4;  // 2
  ADC0GTH   : byte absolute $C5;  // 0
  ADC2GTH   : byte absolute $C5;  // 2
  ADC0LTL   : byte absolute $C6;  // 0
  ADC2LTL   : byte absolute $C6;  // 2
  ADC0LTH   : byte absolute $C7;  // 0
  ADC2LTH   : byte absolute $C7;  // 2
  ...
  REF1CN    : byte absolute $D1;  // 1
  REF2CN    : byte absolute $D1;  // 2
  ...
  DMA0CF    : byte absolute $F8;  // 3
  P7        : byte absolute $F8;  // F
  PCA0L     : byte absolute $F9;  // 0
  DMA0CTL   : byte absolute $F9;  // 3
  PCA0H     : byte absolute $FA;  // 0
  DMA0CTH   : byte absolute $FA;  // 3
  PCA0CPL0  : byte absolute $FB;  // 0
  DMA0CSL   : byte absolute $FB;  // 3
  PCA0CPH0  : byte absolute $FC;  // 0
  DMA0CSH   : byte absolute $FC;  // 3
  PCA0CPL1  : byte absolute $FD;  // 0
  DMA0BND   : byte absolute $FD;  // 3
  PCA0CPH1  : byte absolute $FE;  // 0
  DMA0ISW   : byte absolute $FE;  // 3
  ...
  DMA0DO0   : boolean absolute $D8;  // DMA0CN (page 3)
  DMA0DO1   : boolean absolute $D9;
  DMA0DOE   : boolean absolute $DA;
  DMA0DE0   : boolean absolute $DB;
  DMA0DE1   : boolean absolute $DC;
  DMA0MD    : boolean absolute $DD;
  DMA0INT   : boolean absolute $DE;
  DMA0EN    : boolean absolute $DF;

  AD0WINT   : boolean absolute $E9;  // ADC0CN (page 0)
  ...
  AD1CM0    : boolean absolute $E9;  // ADC1CN (page 1)
  AD1CM1    : boolean absolute $EA;
  AD1CM2    : boolean absolute $EB;
  AD1BUSY   : boolean absolute $EC;
  AD1INT    : boolean absolute $ED;
  AD1TM     : boolean absolute $EE;
  AD1EN     : boolean absolute $EF;

  AD2LJST   : boolean absolute $E8;  // ADC2CN (page 2)
  AD2WINT   : boolean absolute $E9;
  AD2CM0    : boolean absolute $EA;
  AD2CM1    : boolean absolute $EB;
  ...
  DMA0EO    : boolean absolute $F8;  // DMA0CF (page 3)
  DMA0EOE   : boolean absolute $F9;
  DMA0CI    : boolean absolute $FA;
  DMA0CIE   : boolean absolute $FB;
  DMA0XBY   : boolean absolute $FE;
  DMA0HLT   : boolean absolute $FF;
