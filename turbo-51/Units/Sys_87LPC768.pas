// 87LPC768 processor definition file
// ==================================
// 
...
var
  ...
  CNSW0     : byte absolute $D1;
  CNSW1     : byte absolute $D2;
  CPSW0     : byte absolute $D3;
  CPSW1     : byte absolute $D4;
  CPSW2     : byte absolute $D5;
  CPSW3     : byte absolute $D6;
  CPSW4     : byte absolute $D7;
  I2CON     : byte absolute $D8;
  I2DAT     : byte absolute $D9;
  PWMCON0   : byte absolute $DA;
  PWMCON1   : byte absolute $DB;
  ...
  AD3       : boolean absolute $86;  // because of name conflicts with SFR!
