// PageOne processor definition file
// =================================
// (Winedge WE52PO128)
...
var
  ...
  POCIXR    : byte absolute $E9;
  POCFDB    : byte absolute $EA;
  POCDATA   : byte absolute $EB;
  POCDATB   : byte absolute $EC;
  POCDATC   : byte absolute $ED;
  POCMSGR   : byte absolute $EE;
  POCDECR   : byte absolute $EF;
  ...
  POC_SIGIN : boolean absolute $A4;
  KEY5      : boolean absolute $A5;
  POC_BS1   : boolean absolute $A5;
  KEY6      : boolean absolute $A6;
  POC_BS2   : boolean absolute $A6;
  KEY7      : boolean absolute $A7;
  POC_BS3   : boolean absolute $A7;
  ...
  POCSAGIF  : boolean absolute $D8;  // PIF
  SIO1IF    : boolean absolute $D9;
  ...
  POCSAGIE  : boolean absolute $E8;  // PIE
  SIO1IE    : boolean absolute $E9;
  ...
  POCSAGIP  : boolean absolute $F8;  // PIP
  SIO1IP    : boolean absolute $F9;
