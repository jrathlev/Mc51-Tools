object CompilerOptionsDialog: TCompilerOptionsDialog
  ...
  Caption = 'Pascal compiler options  (Turbo 51)'
  ClientHeight = 245
  ClientWidth = 370
  Color = clBtnFace
  ParentFont = True
  ...
  object edOptions: TLabeledEdit
    ...
    EditLabel.Width = 137
    EditLabel.Height = 13
    EditLabel.Caption = 'Other command line options:'
    TabOrder = 2
  end
  object pcCompiler: TPageControl
    ...
    object tsPascal: TTabSheet
      ...
      ExplicitWidth = 0
      ExplicitHeight = 0
      object gbMemType: TGroupBox
        Left = 0
        Top = 0
        Width = 341
        Height = 146
        Caption = 'Memory allocations for'
        TabOrder = 0
    ...
    object tsCpp: TTabSheet
      ...
      object cbPseudoStack: TCheckBox
        Left = 10
        Top = 125
        Width = 156
        Height = 17
        Caption = 'Use pseudo stack'
        TabOrder = 1
      end
      object cbACall: TCheckBox
        Left = 175
        Top = 125
        Width = 166
        Height = 17
        Caption = 'Use ACALL/AJMP'
        TabOrder = 2
      end
      object rgCompilerVariant: TRadioGroup
        Left = 0
        Top = 0
        Width = 341
        Height = 51
        Caption = 'C compiler variant'
        Columns = 4
        ItemIndex = 0
        Items.Strings = (
          'Standard'
