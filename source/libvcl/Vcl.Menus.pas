...
// modified to enable ShortCutTotext to work with GnuGetText
// array MenuKeyCaps replaced by function
// J. Rathlev - 2012-01-04
...
function MenuKeyCaps (mc : TMenuKeyCap) : string;             // JR - 2012-01-04
begin
  case mc of
...
var
  ...
  begin
    ...
    LPPI := GetDevicePPI;
    LGutterRect.Height := MulDiv(LGutterRect.Height, LPPI, OriginalPPI);
...
{$ENDIF}
  ...
  begin
    ...
    begin
      ...
      GlyphSize.cy := MulDiv(GlyphSize.cy, LPPI, OriginalPPI);
      GlyphSize.cx := MulDiv(GlyphSize.cx, LPPI, OriginalPPI);
