...
// modified to make CreateMessageDialog dpi aware
// J. Rathlev - 2020-04-26
...
{$ENDIF}
    begin
      Inc(IconTextWidth, IconWidth + HorzSpacing);
      if IconTextHeight < IconHeight then IconTextHeight := IconHeight;
    end;
    ButtonCount := 0;
    for B := Low(TMsgDlgBtn) to High(TMsgDlgBtn) do
...
{$ENDIF}
      ...
      begin
        ...
        SetBounds(HorzMargin, VertMargin, IconWidth, IconHeight);
      end;
