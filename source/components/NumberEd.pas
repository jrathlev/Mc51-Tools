(* Delphi component package
   ...
   - TFloatEdit      : FloatÌng point input
   - TFloatRangeEdit : FloatÌng point input with range checking
   - TDegreeEdit     : Input for angular degrees
   - TNumUpDown      : Same as TUpDown but for above components
   - TFloatComboBox  : Combobox for FloatÌng point numbers
   - TDegreeComboBox : Combobox for angular degrees

   new floating point formats:
   - ffNormalized    : FloatÌng point number with exponent divisible by 3 (scientific format)
   - ffPrefix        : FloatÌng point number with appended unit prefix
